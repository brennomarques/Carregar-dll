...
type
  TForm1 = class(TForm)
    ...
    Function eBuscaNome(dado: String):String;  //função para encontrar nome da seção.
    Function eBuscasecao(ArqIni: TIniFile):String;//função para busca a seção informando o nome para buscar
...
function TForm1.eBuscasecao(ArqIni: TIniFile): String;
var
  aux, aux1: string;
  i: Integer;
begin
...
begin
   ...
   begin
    ...
    if FileExists('C:\SOLUTI\profiles.ini') then //aqui verificado de tem o arquivo installs.ini
    begin
      ...
      try
        ...
        begin// AQUI NÃO ENCOTROU A SEÇÃO [INSTALL] É SERA EXECULTADO A SEÇÃO [PROFILE]
          ShowMessage(' [ERROR] :');
